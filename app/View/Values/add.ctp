<div class="row">
    ...
    <?php echo $this->Form->create('Value', array('class' => 'form', 'url' => $this->request->relative)); ?>
        ...
        <?php
            ...
            <div class="row">
            	<? echo $this->Form->input('down_threshold', array_merge(console::$htmlInput, array('div' => array('class' => 'form-group col-md-6')))); ?>
				<? echo $this->Form->input('up_threshold', array_merge(console::$htmlInput, array('div' => array('class' => 'form-group col-md-6')))); ?>
            </div>
