    ...
    Autocomplete.prototype = {
        ...
        getSuggestions: function (q) {
            ...
            if (cr && $.isArray(cr.suggestions)) {
				...
				me.options.params.property = me.options.property;
                $.get(this.options.serviceURL, me.options.params, function (txt) {
        ...
        processResponse: function (text) {
            ...
            try {
                response = eval('(' + text + ')');
				if(this.options.returnArrayName) {
					response = response[this.options.returnArrayName];
				} 
            } catch (err) {
                return;
            }
